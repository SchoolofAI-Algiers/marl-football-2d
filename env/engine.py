...
class Object():
    ...
    def act(self, acceleration: Tuple[float, float], angular_acceleration: float, dt: float, max_speed: float, max_angular_speed: float, friction_factor: float, angular_friction_factor: float, min_length: int, max_length: int, min_width: int, max_width: int,target_rotation: float):
